...
public abstract class CustomViewInjector<CVI extends IViewInjector> implements IViewInjector<CVI> {
    ...
    @Override
    public CVI setText(int id, int res) {
        wrappedInjector.setText(id, res);
        return (CVI) this;
    }

    @Override
    public CVI setText(int id, CharSequence charSequence) {
        wrappedInjector.setText(id, charSequence);
        return (CVI) this;
    }
    ...
    @Override
    public CVI setOnClickListener(int id, View.OnClickListener listener) {
        wrappedInjector.setOnClickListener(id, listener);
        return (CVI) this;
    }
