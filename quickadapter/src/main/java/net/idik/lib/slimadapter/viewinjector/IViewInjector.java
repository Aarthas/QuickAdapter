...
public interface IViewInjector<VI extends IViewInjector> {
    ...
    VI image(int img, String appImgSrc);
    ...
    VI setText(int id, int res);

    VI setText(int id, CharSequence charSequence);
    ...
    VI setOnClickListener(int id, View.OnClickListener listener);

    VI setOnClickListener(View.OnClickListener listener);
