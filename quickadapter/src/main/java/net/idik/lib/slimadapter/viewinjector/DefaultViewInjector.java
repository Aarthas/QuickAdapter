...
public class DefaultViewInjector implements IViewInjector<DefaultViewInjector> {
    ...
    @Override
    public DefaultViewInjector image(int id, String appImgSrc) {
        ImageView view = findViewById(id);
        ImageHandler.display(view.getContext(),view,appImgSrc);
        return null;
    }
    ...
    @Override
    public DefaultViewInjector setText(int id, int res) {
    ...
    @Override
    public DefaultViewInjector setText(int id, CharSequence charSequence) {
        TextView view = findViewById(id);
    ...
    @Override
    public DefaultViewInjector setOnClickListener(int id, View.OnClickListener listener) {
        findViewById(id).setOnClickListener(listener);
        return this;
    }

    @Override
    public DefaultViewInjector setOnClickListener(View.OnClickListener listener) {
